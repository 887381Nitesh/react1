...
const url ='https://apiflip.onrender.com/orders';
...
const PlaceOrder =() =>{
    ...
    const initialValues ={
        ...
        name: "Nitesh Kumar",
        email: "kumarnitesh597@gmail.com",
        cost: Math.floor(Math.random()*1000),
        phone: "8873814769",
        address: "Laxmisagar road no-6, Darbhanga, Bihar",
        };
        ...
        <div className="container1">
            ...
            <div className="panel panel-primary">
                <div className="panel-heading">
                   <center><h3>Order For {params.productName}</h3></center>
                </div>
